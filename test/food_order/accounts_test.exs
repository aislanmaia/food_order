defmodule FoodOrder.AccountsTest do
  ...
  describe "update_user_password/3" do
    ...
    test "updates the password", %{user: user} do
      ...
      assert is_nil(user.password)
      assert Accounts.get_user_by_email_and_password(user.email, "Newvalidpassword2")
    end
  ...
  describe "reset_user_password/2" do
    ...
    test "updates the password", %{user: user} do
      {:ok, updated_user} = Accounts.reset_user_password(user, %{password: "Newvalidpassword3"})
      assert is_nil(updated_user.password)
      assert Accounts.get_user_by_email_and_password(user.email, "Newvalidpassword3")
    end
